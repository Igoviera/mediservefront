      ...
      <div className="w-full max-w-[1000px] h-auto bg-white rounded-[12px] border p-[40px] flex flex-col items-center">
        ...
        <div className="w-full flex flex-col items-center gap-[24px]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-[7.64px] w-full">
            ...
            <Input type="text" placeholder="Profissional" label="Profissional:" value={profissional} onChange={(e) => setProfissional(e.target.value)} />
            <Input type="date" label="Data do atendimento:" value={data} onChange={(e) => setData(e.target.value)} />
            <Input type="time" label="Horário:" value={hora} onChange={(e) => { const value = e.target.value; if (value >= "08:00" && value <= "18:00") setHora(value); }} min="08:00" max="18:00" />
            </div>
